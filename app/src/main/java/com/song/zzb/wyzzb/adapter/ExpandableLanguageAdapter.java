 ...
 */
public class ExpandableLanguageAdapter extends BaseExpandableListAdapter {

    private Context _context;
    private List<LanguageBase> _listDataHeader= new ArrayList(); // header titles

    // child data in format of header title, child title
    private HashMap<String, List<listContent>> _listDataChild= new HashMap<>();;

    public ExpandableLanguageAdapter(Context context, List<LanguageBase> listDataHeader,
