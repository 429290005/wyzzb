 ...
 */
public class ExpandableComputerAdapter extends BaseExpandableListAdapter {

    private Context _context;
    private List<ComputerBase> _listDataHeader= new ArrayList(); // header titles

    // child data in format of header title, child title
    private HashMap<String, List<listContent>> _listDataChild= new HashMap<>();;

    public ExpandableComputerAdapter(Context context, List<ComputerBase> listDataHeader,
