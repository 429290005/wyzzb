 ...
 */
public class ExpandableEnglishAdapter extends BaseExpandableListAdapter {

    private Context _context;
    private List<EnglishBase> _listDataHeader= new ArrayList(); // header titles

    // child data in format of header title, child title
    private HashMap<String, List<listContent>> _listDataChild= new HashMap<>();;

    public ExpandableEnglishAdapter(Context context, List<EnglishBase> listDataHeader,
